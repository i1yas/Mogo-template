...
/***/ function(module, exports) {
	...
	var service = function service() {
		...
		for (var i = 1; i < pictures.length; i++) {
			...
			descriptions[i].style.transform = 'translateY(-70%) scaleY(0)';
		}
		...
		var switcher = {
			...
			change: function change(newIndex) {
				...
				descriptions[this.currentIndex].style.transform = 'translateY(-70%) scaleY(0)';
				setTimeout(function () {
...
//# sourceMappingURL=0.81661abfc55c284df877.hot-update.js.map