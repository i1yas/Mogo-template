...
/***/ function(module, exports) {
	...
	var service = function service() {
		...
		arrowIcons[0].classList.add(modifiers.iconUp);
		...
		var switcher = {
			...
			change: function change(newIndex) {
				...
				arrowIcons[this.currentIndex].classList.remove(modifiers.iconUp);
				arrowIcons[newIndex].classList.add(modifiers.iconUp);
...
//# sourceMappingURL=0.0f01eea788ccc11ada0a.hot-update.js.map