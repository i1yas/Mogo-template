		...
		var _loop = function _loop(i) {
			if (!arrowIcons[i].classList) {
				...
				arrowIcons[i].classList.remove = function (removedClass) {
					...
					for (var k = 0; k < undefined.length; k++) {
						if (k === index) {
							k + 1 === undefined.length ? undefined.length = undefined.length - 1 : undefined[index] = undefined[k + 1];
						}
	
						if (k + 1 === undefined.length) {
							undefined.length = undefined.length - 1;
						}
	
						if (k > index) {
							undefined[index] = undefined[k + 1];
						}
					}
					arrowIcons[i].className = undefined.join(' ');
				};
...
//# sourceMappingURL=0.1c8bbd0fb97dba7349bb.hot-update.js.map