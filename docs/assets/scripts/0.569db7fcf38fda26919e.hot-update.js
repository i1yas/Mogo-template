	...
	var service = function service() {
		...
		var switcher = {
			...
			change: function change(newIndex) {
				...
				arrowIcons[this.currentIndex].classList.remove('service__arrow-icons');
				arrowIcons[newIndex].classList.add('service__arrow-icons');
			}
		};
...
//# sourceMappingURL=0.569db7fcf38fda26919e.hot-update.js.map