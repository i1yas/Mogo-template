...
/***/ function(module, exports) {
	...
	var service = function service() {
		...
		descriptions[0].classList.add('service__menu-desc_open');
		...
		var switcher = {
			...
			change: function change(newIndex) {
				...
				arrowIcons[this.currentIndex].classList.remove('service__arrow-icon_up');
				arrowIcons[newIndex].classList.add('service__arrow-icon_up');
...
//# sourceMappingURL=0.c4e815761c9e8d982480.hot-update.js.map