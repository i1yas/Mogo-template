...
/***/ function(module, exports) {
	...
	var service = function service() {
		...
		for (var i = 1; i < pictures.length; i++) {
			...
			descriptions[i].style.transform = 'translate(-100%) scale(0)';
		}
		...
		var switcher = {
			...
			change: function change(newIndex) {
				...
				descriptions[this.currentIndex].style.transform = 'translate(-100%) scale(0)';
				setTimeout(function () {
					...
					descriptions[newIndex].style.transform = 'translate(0) scale(1)';
				}, 110);
...
//# sourceMappingURL=0.f6d5aec8ad587354ac13.hot-update.js.map